...
#
# Script generated by Vivado on Fri Oct 31 17:26:19 +0900 2025
...
#
# Usage        : Zynq_PS.sh
#                Zynq_PS.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Zynq_PS.sh [-reset_run]
#                Zynq_PS.sh [-reset_log]
#                Zynq_PS.sh [-help]
#
...
export RDI_DATADIR="C:/ProgramFiles/Xilinx/2025.1/Vivado/data"
...
# script info
echo -e "Zynq_PS.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Zynq_PS.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/ProgramFiles/Xilinx/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Zynq_PS.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Zynq_PS.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Zynq_PS.sh [-help]\n\
Usage: Zynq_PS.sh [-step]\n\
Usage: Zynq_PS.sh [-lib_map_path]\n\
Usage: Zynq_PS.sh [-reset_run]\n\
Usage: Zynq_PS.sh [-reset_log]\n\
Usage: Zynq_PS.sh [-keep_index]\n\
Usage: Zynq_PS.sh [-noclean_files]\n\n\
